  ...
  try {
    ...
    const system = [
      ...
      [
        ...
        "",
        "[한국어다운 표현 — 영어 직역 톤 금지]",
        "- 영어를 번역한 듯한 제목·문형 금지: \"~에 대한 모든 것\", \"~하는 방법 5가지\", \"왜 ~일까요?\", \"~의 미래\", \"~를 위한 완벽 가이드\", \"게임 체인저\", \"~의 시대가 왔다\", \"~을 소개합니다\" 류.",
        "- 한국 뉴스·경제 기사에서 실제 쓰는 표현을 쓴다: \"~가 달라집니다\", \"~는 이렇게 바뀝니다\", \"~가 관건입니다\", \"~에 무게가 실립니다\", \"~하는 분위기입니다\", \"~로 가닥이 잡혔습니다\", \"~부터 챙겨야 합니다\".",
        "- 주어를 영어처럼 문장마다 반복하지 않는다. 한국어는 주어를 생략할 때 더 자연스럽다.",
        "- '~의'를 연달아 쓰지 않는다: \"구글의 검색의 변화\" → \"구글 검색이 달라진 것\".",
        "- 카드 lines는 개조식(명사 마침)과 서술형(~습니다)을 섞어도 되지만, 한 카드 안에서는 통일한다.",
        "- 출력 전 모든 제목·문장을 소리 내 읽는다고 상상하고, 한국 사람이 실제로 쓰지 않는 표현이 있으면 고쳐 쓴다.",
        "",
        "[톤 — 전문 브리핑]",
